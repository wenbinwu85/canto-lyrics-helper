...
class Mojim:
    def __init__(self, artist=''):
        self._artist = artist
        self.artist_page = f'https://mojim.com/{self.artist}.html?g1',
    ...
    def _find_urls(self, song):
        try: 
            soup = self._make_soup(f'https://mojim.com/{song}.html?g3')
    ...
    def save(self, song):
        song_urls = self._find_urls(song)
